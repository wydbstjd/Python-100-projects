...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=check_img, highlightthickness=0, bg=THEME_COLOR, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        cross_img = PhotoImage(file="./images/false.png")
        self.false_button = Button(image=cross_img, highlightthickness=0, bg=THEME_COLOR, command=self.false_pressed)
    ...
    def fill_canvas(self, value):
        self.canvas.config(bg=value)